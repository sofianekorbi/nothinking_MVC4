...
using nothinking_MVC4.Filters;
using nothinking_MVC4.Models;

namespace nothinking_MVC4.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new { Email = model.Email, Prenom = model.Prenom, Nom = model.Nom, CouleurPref = model.CouleurPref }, false);
